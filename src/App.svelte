...
<div class="absolute left-0 text-center w-full h-full">
    ...
    bg-white bg-opacity-50 p-5 rounded-lg shadow-xl">
        <h1 class="font-bold text-2xl">Post Count Progress Bar</h1>
    ...
    <div class="relative top-5 left-1/2 -translate-x-1/2 w-fit rounded-md p-3 bg-white bg-opacity-30 shadow-sm">
        Copyright &copy; {new Date().getFullYear()} 
        <a href="https://scratch.mit.edu/users/Mrcomputer1" target="_blank" class={LINK_CLASS}>Mrcomputer1</a> &bullet;
        <a href="https://github.com/Mrcomputer1/PostCountProgressBar/blob/master/LICENSE" target="_blank" class={LINK_CLASS}>MIT License</a> &bullet;
        <a href="https://github.com/Mrcomputer1/PostCountProgressBar" target="_blank" class={LINK_CLASS}>Source Code</a>
    </div>
</div>
